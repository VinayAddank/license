 ...
 */
@Service
public class RSCDetailsService extends AbstractDetailsService {

	private static final Logger log = Logger.getLogger(RSCDetailsService.class);
    ...
    public GeneralDetails getDetails(String aadharNumber, String uniqueKey) {
        ...
        return GeneralDetails.builder().add(getCustomerDetails(vehicleRcId)).add(getVehicleDetails(vehicleRcId))
                ...
                .add(getNocDetails(vehicleRcId)).build();
    }
}
