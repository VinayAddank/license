...
@Service
@Qualifier("appSearchPCRVServiceImpl")
public class AppSearchPCRVServiceImpl extends AbstractAppSearchService implements AppSearchService {

	private static final Logger log = Logger.getLogger(AppSearchPCRVServiceImpl.class);
