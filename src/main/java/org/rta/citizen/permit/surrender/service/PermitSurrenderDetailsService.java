...
@Service
public class PermitSurrenderDetailsService extends AbstractDetailsService{

	private static final Logger logger = Logger.getLogger(PermitSurrenderDetailsService.class);
