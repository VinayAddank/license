...
@Service
public class PermitRenewalDetailsService extends AbstractDetailsService{

	private static final Logger logger = Logger.getLogger(PermitRenewalDetailsService.class);
