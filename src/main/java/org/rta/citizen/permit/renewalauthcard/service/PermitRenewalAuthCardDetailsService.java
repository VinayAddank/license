...
@Service
public class PermitRenewalAuthCardDetailsService extends AbstractDetailsService{

	private static final Logger logger = Logger.getLogger(PermitRenewalAuthCardDetailsService.class);
