...
public class AppSearchPTServiceImpl extends AbstractAppSearchService implements AppSearchService{
	@Autowired
	...
	public ResponseModel<ApplicationStatusModel> getApplicationStatus(String appNo, Long sessionId)
		...
		mdl.setApplicationType(ServiceType.PAY_TAX.getLabel());
		mdl.setServiceCode(ServiceType.PAY_TAX.getCode());
