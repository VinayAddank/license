...
@Service
public class FitnessFreshDetailsService extends AbstractDetailsService{

		private static final Logger logger = Logger.getLogger(FitnessFreshDetailsService.class);
