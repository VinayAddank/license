package org.rta.citizen.fitness.revocation.service;
...
@Service
public class FitnessRevocationDetailsService extends AbstractDetailsService{
	
	private static final Logger logger = Logger.getLogger(FitnessRevocationDetailsService.class);
