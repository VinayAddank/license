package org.rta.citizen.fitness.renewal.service;
...
@Service
public class FitnessRenewalDetailsService extends AbstractDetailsService{

	private static final Logger logger = Logger.getLogger(FitnessRenewalDetailsService.class);
