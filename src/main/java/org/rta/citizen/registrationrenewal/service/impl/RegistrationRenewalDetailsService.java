...
@Service
public class RegistrationRenewalDetailsService extends AbstractDetailsService {

	private static final Logger logger = Logger.getLogger(RegistrationRenewalDetailsService.class);
