...
public class AppSearchRRServiceImpl extends AbstractAppSearchService implements AppSearchService {

	private static final Logger log = Logger.getLogger(AppSearchRRServiceImpl.class);
	...
	public ResponseModel<ApplicationStatusModel> getApplicationStatus(String appNo, Long sessionId) throws UnauthorizedException, NotFoundException {
		...
		mdl.setApplicationType(ServiceType.REGISTRATION_RENEWAL.getLabel());
		mdl.setServiceCode(ServiceType.REGISTRATION_RENEWAL.getCode());
