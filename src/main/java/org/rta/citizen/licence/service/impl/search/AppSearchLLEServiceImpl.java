...
public class AppSearchLLEServiceImpl extends AbstractAppSearchService implements AppSearchService {

	private static final Logger log = Logger.getLogger(AppSearchLLEServiceImpl.class);
	...
	public ResponseModel<ApplicationStatusModel> getApplicationStatus(String appNo, Long sessionId)
		...
		mdl.setApplicationType(ServiceType.LL_ENDORSEMENT.getLabel());
		mdl.setServiceCode(ServiceType.LL_ENDORSEMENT.getCode());
