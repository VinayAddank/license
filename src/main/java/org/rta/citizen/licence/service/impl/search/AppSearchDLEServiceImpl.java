...
public class AppSearchDLEServiceImpl extends AbstractAppSearchService implements AppSearchService {

	private static final Logger log = Logger.getLogger(AppSearchDLEServiceImpl.class);
	...
	public ResponseModel<ApplicationStatusModel> getApplicationStatus(String appNo, Long sessionId)
		...
		mdl.setApplicationType(ServiceType.DL_ENDORSMENT.getLabel());
		mdl.setServiceCode(ServiceType.DL_ENDORSMENT.getCode());
