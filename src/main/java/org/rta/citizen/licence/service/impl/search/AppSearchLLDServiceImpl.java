...
public class AppSearchLLDServiceImpl extends AbstractAppSearchService implements AppSearchService {

	private static final Logger log = Logger.getLogger(AppSearchLLDServiceImpl.class);
	...
	public ResponseModel<ApplicationStatusModel> getApplicationStatus(String appNo, Long sessionId)
        ...
        mdl.setApplicationType(ServiceType.LL_DUPLICATE.getLabel());
        mdl.setServiceCode(ServiceType.LL_DUPLICATE.getCode());
