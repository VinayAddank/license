...
@Service
public class DrivingLiceneceDuplicateAuthendication extends AuthenticationService {

	private static final Logger log = Logger.getLogger(DrivingLiceneceDuplicateAuthendication.class);
