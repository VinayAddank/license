...
public class AppSearchDLCServiceImpl extends AbstractAppSearchService implements AppSearchService {

	private static final Logger log = Logger.getLogger(AppSearchDLCServiceImpl.class);
	...
	public ResponseModel<ApplicationStatusModel> getApplicationStatus(String appNo, Long sessionId)
		...
		mdl.setApplicationType(ServiceType.DL_REVO_SUS.getLabel());
		mdl.setServiceCode(ServiceType.DL_REVO_SUS.getCode());
