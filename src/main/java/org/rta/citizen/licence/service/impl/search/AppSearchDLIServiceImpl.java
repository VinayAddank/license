...
public class AppSearchDLIServiceImpl extends AbstractAppSearchService implements AppSearchService {
	...
	public ResponseModel<ApplicationStatusModel> getApplicationStatus(String appNo, Long sessionId)
		...
		mdl.setApplicationType(ServiceType.DL_DLINFO.getLabel());
		mdl.setServiceCode(ServiceType.DL_DLINFO.getCode());
