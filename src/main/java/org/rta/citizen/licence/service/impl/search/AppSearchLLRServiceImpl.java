...
public class AppSearchLLRServiceImpl extends AbstractAppSearchService implements AppSearchService {

	private static final Logger log = Logger.getLogger(AppSearchLLRServiceImpl.class);
	...
	public ResponseModel<ApplicationStatusModel> getApplicationStatus(String appNo, Long sessionId)
		...
		mdl.setApplicationType(ServiceType.LL_RETEST.getLabel());
		mdl.setServiceCode(ServiceType.LL_RETEST.getCode());
