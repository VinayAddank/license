...
@Service
public class DrivingLicenceSurrenderAuthendication extends AuthenticationService {

	private static final Logger log = Logger.getLogger(DrivingLicenceSurrenderAuthendication.class);
	...
	public ResponseModel<TokenModel> authenticate(AuthenticationModel citizen, ServiceType serviceType,
		...
		List<String> checkList = new ArrayList<>(Arrays.asList(ServiceType.LL_FRESH.getCode(),
				...
				ServiceType.DL_BADGE.getCode(), ServiceType.DL_REVO_SUS.getCode(), ServiceType.DL_EXPIRED.getCode(),
