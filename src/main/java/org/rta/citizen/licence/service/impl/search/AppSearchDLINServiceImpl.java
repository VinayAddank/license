...
public class AppSearchDLINServiceImpl extends AbstractAppSearchService implements AppSearchService {

	private static final Logger log = Logger.getLogger(AppSearchDLINServiceImpl.class);
	...
	public ResponseModel<ApplicationStatusModel> getApplicationStatus(String appNo, Long sessionId)
		...
		mdl.setApplicationType(ServiceType.DL_INT_PERMIT.getLabel());
		mdl.setServiceCode(ServiceType.DL_INT_PERMIT.getCode());
