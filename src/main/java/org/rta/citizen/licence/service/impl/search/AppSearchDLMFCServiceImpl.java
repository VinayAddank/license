...
public class AppSearchDLMFCServiceImpl extends AbstractAppSearchService implements AppSearchService {

	private static final Logger log = Logger.getLogger(AppSearchDLMFCServiceImpl.class);
	...
	public ResponseModel<ApplicationStatusModel> getApplicationStatus(String appNo, Long sessionId)
		...
		mdl.setApplicationType(ServiceType.DL_MILITRY.getLabel());
		mdl.setServiceCode(ServiceType.DL_MILITRY.getCode());
