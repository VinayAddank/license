...
public class AppSearchDLSCServiceImpl extends AbstractAppSearchService implements AppSearchService {

	private static final Logger log = Logger.getLogger(AppSearchDLSCServiceImpl.class);
	...
	public ResponseModel<ApplicationStatusModel> getApplicationStatus(String appNo, Long sessionId)
		...
		mdl.setApplicationType(ServiceType.DL_BADGE.getLabel());
		mdl.setServiceCode(ServiceType.DL_BADGE.getCode());
