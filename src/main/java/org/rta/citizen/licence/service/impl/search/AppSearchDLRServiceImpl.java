...
public class AppSearchDLRServiceImpl extends AbstractAppSearchService implements AppSearchService {

	private static final Logger log = Logger.getLogger(AppSearchDLRServiceImpl.class);
	...
	public ResponseModel<ApplicationStatusModel> getApplicationStatus(String appNo, Long sessionId)
		...
		mdl.setApplicationType(ServiceType.DL_RENEWAL.getLabel());
		mdl.setServiceCode(ServiceType.DL_RENEWAL.getCode());
