...
public class AppSearchDLCAServiceImpl extends AbstractAppSearchService implements AppSearchService {
	...
	public ResponseModel<ApplicationStatusModel> getApplicationStatus(String appNo, Long sessionId)
		...
		mdl.setApplicationType(ServiceType.DL_CHANGE_ADDRESS.getLabel());
		mdl.setServiceCode(ServiceType.DL_CHANGE_ADDRESS.getCode());
