...
public class AppSearchDRServiceImpl extends AbstractAppSearchService implements AppSearchService {

	private static final Logger log = Logger.getLogger(AppSearchDRServiceImpl.class);
	...
	public ResponseModel<ApplicationStatusModel> getApplicationStatus(String appNo, Long sessionId) throws UnauthorizedException, NotFoundException {
		...
		mdl.setApplicationType(ServiceType.DUPLICATE_REGISTRATION.getLabel());
		mdl.setServiceCode(ServiceType.DUPLICATE_REGISTRATION.getCode());
