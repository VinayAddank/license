...
@Service
public class VehicleReassignmentDetailsService extends AbstractDetailsService {

	private static final Logger logger = Logger.getLogger(VehicleReassignmentDetailsService.class);
