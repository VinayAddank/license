...
@Service
public class RegistrationCancellationDetailsService extends AbstractDetailsService {

	private static final Logger logger = Logger.getLogger(RegistrationCancellationDetailsService.class);
