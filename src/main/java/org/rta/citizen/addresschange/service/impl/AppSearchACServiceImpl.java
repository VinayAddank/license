...
public class AppSearchACServiceImpl extends AbstractAppSearchService  implements AppSearchService {

	private static final Logger log = Logger.getLogger(AppSearchACServiceImpl.class);
    ...
    public ResponseModel<ApplicationStatusModel> getApplicationStatus(String appNo, Long sessionId) throws UnauthorizedException, NotFoundException {
        ...
        mdl.setApplicationType(ServiceType.ADDRESS_CHANGE.getLabel());
        mdl.setServiceCode(ServiceType.ADDRESS_CHANGE.getCode());
